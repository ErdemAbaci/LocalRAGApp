...
- Unit testler `67/67` başarılı (chunking, atomik reindex/manifest, indeks güncelliği, güvenli TXT/PDF yönetimi, interaktif/tek-komut CLI, Rich çıktıları, model yükleme ve LLM cevap temizliği).
...
1. Phi modellerini süre ve Türkçe cevap kalitesiyle karşılaştıran benchmark akışı oluştur.
